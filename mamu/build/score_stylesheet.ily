...
\header {
	...
	title =  \markup \center-column {
			\line {
				...
				\fontsize #-3 "t o   A m e l i a   K o r b i t z"
			}
            \override #'(font-name . "Bell MT")
            \fontsize #0.8
            \line {
            ...
            \line {
                \vspace #2.3
                \override #'(font-name . "Assurbanipal")\fontsize #8 \char ##x1202D \hspace #2.5
                \override #'(font-name . "Assurbanipal")\fontsize #8 \char ##x12220 \hspace #2.5
                \override #'(font-name . "Assurbanipal")\fontsize #8 \char ##x122AC
            }
			\line{
                \vspace #2
                \fontsize #-3 \override #'(font-name . "Bell MT")"o r ,   "
                \fontsize #-3 \override #'(font-name . "Noto Serif")"N ύ χ τ α β ο ή :   "
                \fontsize #-3 \override #'(font-name . "Bell MT")"p r o l o g u e"
			}
...
\paper {
	...
	oddFooterMarkup = \markup
        \fill-line {
			...
			\concat {
			\fontsize #3
			"mamu"\hspace #1.5 — \hspace #1.5 \override #'(font-name . "Noto Sans Cuneiform") \char ##x1202D \char ##x12220 \char ##x122AC \hspace #1.5 — \hspace #1.5 \fontsize #3 GR \hspace #1 \fontsize #3 Evans
			}
	        \concat {
	            \fontsize #3
